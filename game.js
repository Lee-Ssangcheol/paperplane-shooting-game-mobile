...
let fireDelay = 1000;  // 기본 발사 딜레이 (끊어서 발사할 때 - 더 느리게)
let continuousFireDelay = 70;  // 연속 발사 딜레이 (빠르게)
...
function setupTouchDragControls() {
    ...
    canvas.addEventListener('touchstart', (e) => {
        ...
        let newX = touchX - player.width / 4; // 터치 지점을 기준으로 플레이어 중심을 왼쪽으로 조정하여 일정한 거리 유지
